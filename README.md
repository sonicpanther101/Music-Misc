# Miscilaneous Music parsing tools

## Rules my music must follow

### Stage 1
- All Flacs
#### Tagging
- All files need to have artist, `title`, `album`, `date` and `album artist` tags
- If multiple artists, split by `;`
- If album artist is missing, it can be the artist, if multiple artists, then the one who produced the album
- Date needs to just be the year of release
